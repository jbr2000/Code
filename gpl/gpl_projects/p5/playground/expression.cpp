...
Expression* Expression::evaluate_to_type(Gpl_type desired_type) {
    stringstream ss;
    // Expression's value is already the correct type
    if (return_type == desired_type)
...
Expression* Expression::evaluate() {
    ...
    switch (node_type) {
        ...
        case BINARY_OPERATOR:
            if (right->return_type != return_type)
    ...
    switch (return_type) {
        case INT: {
            ...
            switch (operator_type) {
                case PLUS:     cout << left_i_value << " + " << right_i_value << endl;
                    return new Expression(new int(left_i_value + right_i_value), INT, NULL, NULL); break;
                case MINUS:    cout << left_i_value << " - " << right_i_value << endl;
                    return new Expression(new int(left_i_value - right_i_value), INT, NULL, NULL); break;
                case MULTIPLY: cout << left_i_value << " * " << right_i_value << endl;
                    return new Expression(new int(left_i_value * right_i_value), INT, NULL, NULL); break;
                case DIVIDE:   cout << left_i_value << " / " << right_i_value << endl;
                    return new Expression(new int(left_i_value / right_i_value), INT, NULL, NULL); break;
                case MOD:      cout << left_i_value << " % " << right_i_value << endl;
                    return new Expression(new int(left_i_value % right_i_value), INT, NULL, NULL); break;
                // BINARY_LOGICAL
                case OR:                 cout << left_i_value << " || " << right_i_value << endl;
                    return new Expression(new int(left_i_value || right_i_value), INT, NULL, NULL); break;
                case AND:                cout << left_i_value << " && " << right_i_value << endl;
                    return new Expression(new int(left_i_value && right_i_value), INT, NULL, NULL); break;
                case EQUAL:              cout << left_i_value << " == " << right_i_value << endl;
                    return new Expression(new int(left_i_value == right_i_value), INT, NULL, NULL); break;
                case NOT_EQUAL:          cout << left_i_value << " != " << right_i_value << endl;
                    return new Expression(new int(left_i_value != right_i_value), INT, NULL, NULL); break;
                case LESS_THAN:          cout << left_i_value << " < " << right_i_value << endl;
                    return new Expression(new int(left_i_value < right_i_value), INT, NULL, NULL); break;
                case LESS_THAN_EQUAL:    cout << left_i_value << " <= " << right_i_value << endl;
                    return new Expression(new int(left_i_value <= right_i_value), INT, NULL, NULL); break;
                case GREATER_THAN:       cout << left_i_value << " > " << right_i_value << endl;
                    return new Expression(new int(left_i_value > right_i_value), INT, NULL, NULL); break;
                case GREATER_THAN_EQUAL: cout << left_i_value << " >= " << right_i_value << endl;
                    return new Expression(new int(left_i_value >= right_i_value), INT, NULL, NULL); break;
                // UNARY
